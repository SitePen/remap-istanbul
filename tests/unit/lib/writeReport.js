define([
	...
	registerSuite({
		...
		setup: function () {
			coverage = remap.default(loadCoverage.default('tests/unit/support/coverage.json'));
		},

		'invalid': function () {
			var dfd = this.async();
			writeReport.default(coverage, 'foo', {}, 'bar').then(dfd.reject, dfd.callback(function (error) {
		...
		'clover': function () {
			return writeReport.default(coverage, 'clover', {}, 'tmp/clover.xml').then(function () {
		...
		'cobertura': function () {
			return writeReport.default(coverage, 'cobertura', {}, 'tmp/cobertura.xml').then(function () {
		...
		'html': function () {
			return writeReport.default(coverage, 'html', {}, 'tmp/html-report').then(function () {
		...
		'html with inlines sources': function () {
			...
			var inlineSourceCoverage = remap.default(loadCoverage.default('tests/unit/support/coverage-inlinesource.json'), {
				sources: sources
			});
			return writeReport.default(inlineSourceCoverage, 'html', {}, 'tmp/html-report-inline', sources).then(function () {
		...
		'json-summary': function () {
			return writeReport.default(coverage, 'json-summary', {}, 'tmp/summary.json').then(function () {
		...
		'json': function () {
			return writeReport.default(coverage, 'json', {}, 'tmp/coverage-out.json').then(function () {
		...
		'lcovonly': function () {
			return writeReport.default(coverage, 'lcovonly', {}, 'tmp/lcov.info').then(function () {
		...
		'teamcity': function () {
			return writeReport.default(coverage, 'teamcity', {}, 'tmp/teamcity.txt').then(function () {
		...
		'text-lcov': {
			'no dest': function () {
				...
				console.log = mockLog;
				return writeReport.default(coverage, 'text-lcov', {}).then(function () {
			...
			'dest': function () {
				return writeReport.default(coverage, 'text-lcov', {}, function () {
					consoleOutput.push(arguments);
				}).then(function () {
					assert.strictEqual(consoleOutput.length, 59,
						'console should have the right number of lines');
		...
		'text-summary': function () {
			return writeReport.default(coverage, 'text-summary', {}, 'tmp/summary.txt').then(function () {
		...
		'text': function () {
			return writeReport.default(coverage, 'text', {}, 'tmp/coverage.txt').then(function () {
